const ID_LIST_BELUM = "Beforelist";
const ID_LIST_SUDAH = "Afterlist";
const ID_BUKU = "idBuku";

function buatListBaca(judulB, penulisB, tahunB, waktuB, isComplete) {
    ...
    waktuBuku.innerText = "Target Baca Buku Selesai : ";
